...
if ( ! class_exists( 'ESGI_Custom_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * @since Twenty Twenty-One 1.0
	 */
	class ESGI_Custom_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->register_control_type( 'ESGI_Custom_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new ESGI_Custom_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
