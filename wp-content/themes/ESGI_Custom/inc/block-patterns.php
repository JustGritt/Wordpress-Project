...
if ( function_exists( 'register_block_pattern_category' ) ) {
	 ...
	 * @return void
	 */
	function ESGI_Custom_register_block_pattern_category() {
		register_block_pattern_category(
			'twentytwentyone',
			array( 'label' => esc_html__( 'Twenty Twenty-One', 'twentytwentyone' ) )
		);
	}
	add_action( 'init', 'ESGI_Custom_register_block_pattern_category' );
}
...
if ( function_exists( 'register_block_pattern' ) ) {
	 ...
	 * @return void
	 */
	function ESGI_Custom_register_block_pattern() {
	...
	add_action( 'init', 'ESGI_Custom_register_block_pattern' );
}
